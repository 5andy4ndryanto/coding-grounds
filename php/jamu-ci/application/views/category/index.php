<div class="panel">
	<div class="panel-heading">
		<div class="col-md-6">
			...
			<a href="<?php echo site_url('category/index');?>" class="btn btn-default">
				Refresh
			</a>
		</div>
		<div class="col-md-6">
					...
					<?php foreach($results as $row): ?>
						<tr>
							...
							<td class="text-center">
								<a href="<?php echo site_url('category/edit/'.$row->id);?>" class="btn btn-sm btn-default">Ubah</a>
								<a href="<?php echo site_url('category/show/'.$row->id);?>" class="btn btn-sm btn-default">Lihat</a>
								<a onclick="return confirm('Apakah anda yakin ?');" href="<?php echo site_url('category/delete/'.$row->id);?>" class="btn btn-sm btn-default">
									Hapus
								</a>
							</td>
						</tr>
